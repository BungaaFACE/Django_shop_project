...
from email_distribution.models import Client, EmailFilling, EmailSubscribtion, EmailSubscribtionLogs
...
def start_distribution_task():
    ...
    for distribution in list_of_distributions:
        ...
        for client in distribution.client.all():
            ...
            # Если хоть одно сообщение отправилось - считаем успешным
            if sending_result:
