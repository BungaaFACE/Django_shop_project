...
from email_distribution import views

urlpatterns = [
    path('', views.email_distribution_menu, name='email_distribution'),
    path('manager_menu/', views.ManagerTableView.as_view(), name='manager_menu'),
